...
func (u *NaiveUser) Email() string       { return u.EmailAddress }
...
// there is a match.
func (um *NaiveUserManager) GetUserByToken(_ context.Context, token string) (User, error) {
...
func (um *NaiveUserManager) GetOrCreateUser(u User) (User, error) {
